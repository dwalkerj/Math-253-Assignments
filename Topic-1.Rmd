...
### D
A flexible model would work best because that is our best way to reduce our total error. If we have a large amount of irreducible error, it would be best to come up with a flexible model in order to reduce our reducible error. However, this may run the risk of overfitting.
